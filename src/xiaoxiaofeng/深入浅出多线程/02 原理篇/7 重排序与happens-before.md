...
![正确同步图](https://image.xiaoxiaofeng.site/blog/2023/05/17/xxf-20230517100901.png?xxfjava)

操作的执行整体上有序，并且两个线程都只能看到这个执行顺序。

假设**没有使用同步**，那么在**顺序一致性模型**中的执行效果如下所示：

![没有正确同步图](https://image.xiaoxiaofeng.site/blog/2023/05/17/xxf-20230517100904.png?xxfjava)
