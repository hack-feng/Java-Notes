...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154724731.png) 

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154725086.png) 
...
![通过构造方法实现](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121100657.png?xxfjava)

**方式二：通过 `Executor` 框架的工具类 `Executors` 来创建。**

`Executors`工具类提供的创建线程池的方法如下图所示：

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154725457.png)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154725950.png) 
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154726890.png) 
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154727307.png) 
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154727640.png) 
...
美团技术团队在[《Java 线程池实现原理及其在美团业务中的实践》][Java]这篇文章中介绍到对线程池参数实现可自定义配置的思路和方法。
...
我在[Java 线程池详解][Java 1] 这篇文章中就说过这三个参数是 `ThreadPoolExecutor` 最重要的参数，它们基本决定了线程池对于任务的处理策略。

**如何支持参数动态配置？** 且看 `ThreadPoolExecutor` 提供的下面这些方法。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154728066.png)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154728561.png) 

还没看够？推荐 why 神的[如何设置线程池参数？美团给出了一个让面试官虎躯一震的回答。][Link 1]这篇文章，深度剖析，很不错哦！
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154729043.jpg) ThreadPoolExecutor构造函数
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154729750.jpg)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154730070.png)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154730537.png)
...
![笑小枫-www.xiaoxiaofeng.com](https://oss.javaguide.cn/p3-juejin/40cb932a64694262993907ebda6a0bfe)

AQS(`AbstractQueuedSynchronizer`)的核心原理图（图源[Java 并发之 AQS 详解][Java _ AQS]）如下：

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732154730915.png)
...
[ThreadLocal]: https://oss.javaguide.cn/github/javaguide/java/concurrent/threadlocal-data-structure.png
[ThreadLocal 1]: https://oss.javaguide.cn/github/javaguide/java/concurrent/thread-local-inner-class.png
[Image 1]: 
...
[threadpool-reject-2-threadpool-reject-01.png]: https://oss.javaguide.cn/github/javaguide/java/concurrent/threadpool-reject-2-threadpool-reject-01.png
[MySQL]: https://oss.javaguide.cn/github/javaguide/java/concurrent/threadpool-reject-2-threadpool-reject-02.png
...
[issue_1737]: https://github.com/Snailclimb/JavaGuide/issues/1737
[Java]: https://tech.meituan.com/2020/04/02/java-pooling-pratice-in-meituan.html
[Java 1]: https://javaguide.cn/java/concurrent/java-thread-pool-summary.html
[threadpoolexecutor-methods.png]: https://oss.javaguide.cn/github/javaguide/java/concurrent/threadpoolexecutor-methods.png
[meituan-dynamically-configuring-thread-pool-parameters.png]: https://oss.javaguide.cn/github/javaguide/java/concurrent/meituan-dynamically-configuring-thread-pool-parameters.png
[Link 1]: https://mp.weixin.qq.com/s/9HLuPcoWmTqAeFKa1kj-_A
[Hippo4j]: https://github.com/opengoofy/hippo4j
[Dynamic TP]: https://github.com/dromara/dynamic-tp
[ThreadPoolExecutor]: https://oss.javaguide.cn/github/javaguide/java/concurrent/common-parameters-of-threadpool-workqueue.jpg
[completablefuture-class-diagram.jpg]: https://oss.javaguide.cn/github/javaguide/java/concurrent/completablefuture-class-diagram.jpg
[image-20210902093026059.png]: https://oss.javaguide.cn/javaguide/image-20210902093026059.png
[AQS.png]: https://oss.javaguide.cn/github/javaguide/java/AQS.png
[40cb932a64694262993907ebda6a0bfe_tplv-k3u1fbpfcp-zoom-1.png]: https://oss.javaguide.cn/p3-juejin/40cb932a64694262993907ebda6a0bfe~tplv-k3u1fbpfcp-zoom-1.png
[Java _ AQS]: https://www.cnblogs.com/waterystone/p/4920797.html
[CLH.png]: https://oss.javaguide.cn/github/javaguide/java/CLH.png
