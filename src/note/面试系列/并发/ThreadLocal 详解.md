![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110235.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110304.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110327.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110335.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110341.png?xxfjava)

如果我们的**强引用**不存在的话，那么 `key` 就会被回收，也就是会出现我们 `value` 没被回收，`key` 被回收，导致 `value` 永远存在，出现内存泄漏。

### `ThreadLocal.set()`方法源码详解 ###

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110349.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110358.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110404.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110410.png?xxfjava)

这里直接将数据放到该槽位即可。

**第二种情况：** 槽位数据不为空，`key`值与当前`ThreadLocal`通过`hash`计算获取的`key`值一致：

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110416.png?xxfjava)

这里直接更新该槽位的数据。

**第三种情况：** 槽位数据不为空，往后遍历过程中，在找到`Entry`为`null`的槽位之前，没有遇到`key`过期的`Entry`：

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110422.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110427.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110433.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110439.png?xxfjava)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732158005603.png)向后遍历过程中，如果没有找到相同 key 值的 Entry 数据：

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110448.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110456.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110512.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110526.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110531.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110538.png?xxfjava)

我们假设`expungeStaleEntry(3)` 来调用此方法，如上图所示，我们可以看到`ThreadLocalMap`中`table`的数据情况，接着执行清理操作：

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110543.png?xxfjava)

第一步是清空当前`staleSlot`位置的数据，`index=3`位置的`Entry`变成了`null`。然后接着往后探测：

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110548.png?xxfjava)

执行完第二步后，index=4 的元素挪到 index=3 的槽位中。

继续往后迭代检查，碰到正常数据，计算该数据位置是否偏移，如果被偏移，则重新计算`slot`位置，目的是让正常数据尽可能存放在正确位置或离正确位置更近的位置

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110554.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110604.png?xxfjava)

接着看看具体的`resize()`方法，为了方便演示，我们以`oldTab.len=8`来举例：

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110609.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110616.png?xxfjava)

**第二种情况：** `slot`位置中的`Entry.key`和要查找的`key`不一致：

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110622.png?xxfjava)
...
#### ![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110626.png?xxfjava).get()`源码详解 ####
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110632.png?xxfjava)
...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110642.png?xxfjava)

图中的`requestId`即为我们各个系统链路关联的`traceId`，系统间互相调用，通过这个`requestId`即可找到对应链路，这里还有会有一些其他场景：

![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121110648.png?xxfjava)
