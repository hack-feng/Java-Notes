...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732157860865.jpg) BlockingQueue 的实现类
...
**推荐文章：** [《解读 Java 并发队列 BlockingQueue》][Java _ BlockingQueue]

## ConcurrentSkipListMap ##

> 下面这部分内容参考了极客时间专栏[《数据结构与算法之美》][Link 1]以及《实战 Java 高并发程序设计》。
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732157861313.jpg) 

最低层的链表维护了跳表内所有的元素，每上面一层链表都是下面一层的子集。

跳表内的所有链表的元素都是排序的。查找时，可以从顶级链表开始找。一旦发现被查找的元素大于当前链表中的取值，就会转入下一层链表继续找。这也就是说在查找过程中，搜索是跳跃式的。如上图所示，在跳表中查找元素 18。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732157861913.jpg) 
...
[BlockingQueue]: https://oss.javaguide.cn/github/javaguide/java/51622268.jpg
[Java _ BlockingQueue]: https://javadoop.com/post/java-concurrent-queue
[Link 1]: https://time.geekbang.org/column/intro/126?code=zl3GYeAsRI4rEJIBNu5B/km7LSZsPDlGWQEpAYw5Vu0=&utm_term=SPoster
[2]: https://oss.javaguide.cn/github/javaguide/java/93666217.jpg
[18]: https://oss.javaguide.cn/github/javaguide/java/32005738.jpg
