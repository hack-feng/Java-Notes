...
![img](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121095931.png?xxfjava)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153958167.png) 

在 Windows 和 Linux 等主流操作系统中，Java 线程采用的是一对一的线程模型，也就是一个 Java 线程对应一个系统内核线程。Solaris 系统是一个特例（Solaris 系统本身就支持多对多的线程模型），HotSpot VM 在 Solaris 上支持多对多和一对一。具体可以参考 R 大的回答: [JVM 中的线程模型是用户级的么？][JVM]。

### 请简要描述线程与进程的关系,区别及优缺点？ ###

下图是 Java 内存区域，通过下图我们从 JVM 的角度来说一下线程和进程之间的关系。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153958779.png)
...
关于这个问题的详细分析可以查看这篇文章：[大家都说 Java 有三种创建线程的方式！并发编程中的惊天骗局！][Java]。
...
Java 线程状态变迁图(图源：[挑错 |《Java 并发编程的艺术》中关于线程状态的三处错误][_Java])：

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153959248.png)线程状态变迁图
...
> 
> **为什么 JVM 没有区分这两种状态呢？** （摘自：[Java 线程运行怎么有第六种状态？ - Dawell 的回答][Java _ - Dawell] ） 现在的时分（time-sharing）多任务（multi-task）操作系统架构通常都是用所谓的“时间分片（time quantum or time slice）”方式进行抢占式（preemptive）轮转调度（round-robin 式）。这个时间分片通常是很小的，一个线程一次最多只能在 CPU 上运行比如 10-20ms 的时间（此时处于 running 状态），也即大概只有 0.01 秒这一量级，时间片用后就要被切换下来放入调度队列的末尾等待再次调度。（也即回到 ready 状态）。线程切换的如此之快，区分这两种状态就没什么意义了。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153959675.png)
...
![线程死锁示意图 ](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121100026.png?xxfjava)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153960013.png) jconsole
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153960997.png) 
...
[-Windows]: https://oss.javaguide.cn/github/javaguide/java/进程示例图片-Windows.png
[three-types-of-thread-models.png]: https://oss.javaguide.cn/github/javaguide/java/concurrent/three-types-of-thread-models.png
...
[Java]: https://mp.weixin.qq.com/s/NspUsyhEmKnJ-4OprRFp9g
[_Java]: https://mp.weixin.qq.com/s/UOrXql_LhOD8dhTq_EPI0w
[Java 1]: https://oss.javaguide.cn/github/javaguide/java/concurrent/640.png
...
[Java _ - Dawell]: https://www.zhihu.com/question/56494969/answer/154053599
[RUNNABLE-VS-RUNNING]: https://oss.javaguide.cn/github/javaguide/java/RUNNABLE-VS-RUNNING.png
[Link 1]: https://mp.weixin.qq.com/s/R5MrTsWvk9McFSQ7bS0W2w
[2019-4_1.png]: https://oss.javaguide.cn/github/javaguide/java/2019-4死锁1.png
[jconsole]: https://oss.javaguide.cn/github/javaguide/java/concurrent/jdk-home-bin-jconsole.png
[jconsole 1]: https://oss.javaguide.cn/github/javaguide/java/concurrent/jconsole-check-deadlock.png
[jconsole 2]: https://oss.javaguide.cn/github/javaguide/java/concurrent/jconsole-check-deadlock-done.png
