...
`Unsafe`类位于`sun.misc`包下，是一个提供低级别、不安全操作的类。由于其强大的功能和潜在的危险性，它通常用于 JVM 内部或一些需要极高性能和底层访问的库中，而不推荐普通开发者在应用程序中使用。关于 `Unsafe`类的详细介绍，可以阅读这篇文章：📌[Java 魔法类 Unsafe 详解][Java _ Unsafe]。
...
![JUC原子类概览](https://image.xiaoxiaofeng.site/blog/2024/11/21/xxf-20241121104459.png?xxfjava)
...
[Java _ Unsafe]: https://www.xiaoxiaofeng.com/article/1093
[JUC]: https://oss.javaguide.cn/github/javaguide/java/JUC原子类概览.png
[Atomic]: https://www.xiaoxiaofeng.com/article/1094