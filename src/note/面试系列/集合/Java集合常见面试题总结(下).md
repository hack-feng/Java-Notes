...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153173361.png) TreeMap 继承关系图
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153173637.png) jdk1.8 之前的内部结构-HashMap

#### JDK1.8 之后 ####

相比于之前的版本， JDK1.8 之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为 8）（将链表转换成红黑树前会判断，如果当前数组的长度小于 64，那么会选择先进行数组扩容，而不是转换为红黑树）时，将链表转化为红黑树，以减少搜索时间。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153173902.png) jdk1.8之后的内部结构-HashMap
...
一般面试中这样介绍就差不多，不需要记各种细节，个人觉得也没必要记。如果想要详细了解 `HashMap` 扩容导致死循环问题，可以看看耗子叔的这篇文章：[Java HashMap 的死循环][Java HashMap]。
...
[HashMap 的 7 种遍历方式与性能分析！][HashMap _ 7]

**🐛 修正（参见：[issue\#1411][issue_1411]）**：
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153173637.png) Hashtable 的内部结构

https://www.cnblogs.com/chengxiao/p/6842045.html>

**JDK1.7 的 ConcurrentHashMap**：

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153174217.png) Java7 ConcurrentHashMap 存储结构
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732153174516.png) Java8 ConcurrentHashMap 存储结构
...
具体可以参考 [ConcurrentHashMap 源码分析][ConcurrentHashMap] 。
...
[TreeMap]: https://oss.javaguide.cn/github/javaguide/java/collection/treemap_hierarchy.png
[jdk1.8 _-HashMap]: https://oss.javaguide.cn/github/javaguide/java/collection/jdk1.7_hashmap.png
[jdk1.8_-HashMap]: https://oss.javaguide.cn/github/javaguide/java/collection/jdk1.8_hashmap.png
[Java HashMap]: https://coolshell.cn/articles/9606.html
[HashMap _ 7]: https://mp.weixin.qq.com/s/zQBN3UvJDhRTKP6SzcZFKw
[issue_1411]: https://github.com/Snailclimb/JavaGuide/issues/1411
[Java7 ConcurrentHashMap]: https://oss.javaguide.cn/github/javaguide/java/collection/java7_concurrenthashmap.png
[Java8 ConcurrentHashMap]: https://oss.javaguide.cn/github/javaguide/java/collection/java8_concurrenthashmap.png
[ConcurrentHashMap]: https://javaguide.cn/java/collection/concurrent-hash-map-source-code.html
