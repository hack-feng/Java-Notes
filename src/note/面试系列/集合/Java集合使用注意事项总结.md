...
> 如果你还不了解 Java 8 新特性的话，请看这篇文章：[《Java8 新特性总结》][Java8] 。
...
对于不可变集合，你可以使用[`ImmutableList`][ImmutableList]类及其[`of()`][of]与[`copyOf()`][copyOf]工厂方法：（参数不能为空）
...
对于可变集合，你可以使用[`Lists`][Lists]类及其[`newArrayList()`][newArrayList]工厂方法：
...
[Java8]: https://mp.weixin.qq.com/s/ojyl7B6PiHaTWADqmUq2rw
...
[of]: https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/ImmutableList.java#L101
[copyOf]: https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/ImmutableList.java#L225
[Lists]: https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/Lists.java
[newArrayList]: https://github.com/google/guava/blob/master/guava/src/com/google/common/collect/Lists.java#L87
