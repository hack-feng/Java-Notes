在学习 NIO 之前，需要先了解一下计算机 I/O 模型的基础理论知识。还不了解的话，可以参考我写的这篇文章：[Java IO 模型详解][Java IO]。
...
下图是 BIO、NIO 和 AIO 处理客户端请求的简单对比图（关于 AIO 的介绍，可以看我写的这篇文章：[Java IO 模型详解][Java IO]，不是重点，了解即可）。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168575142.png) 
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168575646.png) 
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168576144.png) 
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168576917.png)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168577307.png)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168577711.png) Channel 和 Buffer之间的关系

另外，因为 Channel 是全双工的，所以它可以比流更好地映射底层操作系统的 API。特别是在 UNIX 网络编程模型中，底层操作系统的通道都是全双工的，同时支持读写操作。

`Channel` 的子类如下图所示。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168578120.png) Channel 的子类
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168578656.png) 
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/21/xxf-1732168579163.png)
 ...
 *  `FileChannel` 的`transferTo()/transferFrom()`是 NIO 基于发送文件（`sendfile`）这种零拷贝方式的提供的一种实现，底层实际是调用了 Linux 内核的 `sendfile`系统调用。它可以直接将文件数据从磁盘发送到网络，而不需要经过用户空间的缓冲区。关于`FileChannel`的用法可以看看这篇文章：[Java NIO 文件通道 FileChannel 用法][Java NIO _ FileChannel]。
...
[BIO_NIO _ AIO]: https://oss.javaguide.cn/github/javaguide/java/nio/bio-aio-nio.png
[Buffer_Channel_Selector]: https://oss.javaguide.cn/github/javaguide/java/nio/channel-buffer-selector.png
[Buffer]: https://oss.javaguide.cn/github/javaguide/java/nio/buffer-subclasses.png
[position _limit _ capacity]: https://oss.javaguide.cn/github/javaguide/java/nio/JavaNIOBuffer.png
[position _limit _ capacity 1]: https://oss.javaguide.cn/github/javaguide/java/nio/NIOBufferClassAttributes.png
[capacity_limit_position]: https://oss.javaguide.cn/github/javaguide/java/nio/NIOBufferClassAttributesDataChanges.png
[Channel _ Buffer]: https://oss.javaguide.cn/github/javaguide/java/nio/channel-buffer.png
[Channel]: https://oss.javaguide.cn/github/javaguide/java/nio/channel-subclasses.png
[Channel 1]: https://oss.javaguide.cn/github/javaguide/java/nio/channel-inheritance-relationship.png
[Selector]: https://oss.javaguide.cn/github/javaguide/java/nio/selector-channel-selectionkey.png
[Java NIO _ FileChannel]: https://www.cnblogs.com/robothy/p/14235598.html
