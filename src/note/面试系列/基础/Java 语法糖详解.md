...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732091707385.png)
...
我们这里会用到[反编译][Link 1]，你可以通过 [Decompilers online][] 对 Class 文件进行在线反编译。
...
public static void main(String[] args)
    {
        print("xiaoxiaofeng", "公众号:xiaoxiaofeng", "博客：www.xiaoxiaofeng.com", "wx：xiaoxiaofeng910");
    }
...
{
    print(new String[] {
        "xiaoxiaofeng", "\u516C\u4F17\u53F7:xiaoxiaofeng", "\u535A\u5BA2\uFF1Awww.xiaoxiaofeng.com", "wx\uFF1Axiaoxiaofeng910"
    });
}
...
从反编译后代码可以看出，可变参数在被使用的时候，他首先会创建一个数组，数组的长度就是调用该方法是传递的实参的个数，然后再把参数值全部放到这个数组当中，然后再把这个数组作为参数传递到被调用的方法中。（注：`trasient` 仅在修饰成员变量时有意义，此处 “修饰方法” 是由于在 javassist 中使用相同数值分别表示 `trasient` 以及 `vararg`，见 [此处][Link 2]。）
...
public class AssertTest {
    public static void main(String args[]) {
        ...
        int b = 1;
        assert a == b;
        System.out.println("公众号：xiaoxiaofeng");
        assert a != b : "Hollis";
        System.out.println("博客：www.xiaoxiaofeng.com");
    }
}
```
...
```java
public static void main(String... args) {
    String[] strs = {"Hollis", "公众号：xiaoxiaofeng", "博客：www.xiaoxiaofeng.com"};
    for (String s : strs) {
        System.out.println(s);
    }
    List<String> strList = ImmutableList.of("Hollis", "公众号：xiaoxiaofeng", "博客：www.xiaoxiaofeng.com");
...
{
    String strs[] = {
        "Hollis", "\u516C\u4F17\u53F7\uFF1Axiaoxiaofeng", "\u535A\u5BA2\uFF1Awww.xiaoxiaofeng.com"
    };
    String args1[] = strs;
    int i = args1.length;
    for(int j = 0; j < i; j++)
    ...
    List strList = ImmutableList.of("Hollis", "\u516C\u4F17\u53F7\uFF1Axiaoxiaofeng", "\u535A\u5BA2\uFF1Awww.xiaoxiaofeng.com");
    String s;
...
public static void main(String[] args) {
    ...
    try {
        String line;
        br = new BufferedReader(new FileReader("d:\\xiaoxiaofeng.xml"));
...
```java
public static void main(String... args) {
    try (BufferedReader br = new BufferedReader(new FileReader("d:\\ xiaoxiaofeng.xml"))) {
        String line;
        while ((line = br.readLine()) != null) {
            System.out.println(line);
        }
...
public static /* varargs */ void main(String ... args) {
    ImmutableList strList = ImmutableList.of((Object)"Hollis", (Object)"\u516c\u4f17\u53f7\uff1axiaoxiaofeng", (Object)"\u535a\u5ba2\uff1awww.xiaoxiaofeng.com");
...
[image-20220818175953954.png]: https://oss.javaguide.cn/github/javaguide/java/basis/syntactic-sugar/image-20220818175953954.png
[Link 1]: https://mp.weixin.qq.com/s?__biz=MzI3NzE0NjcwMg==&mid=2650120609&idx=1&sn=5659f96310963ad57d55b48cee63c788&chksm=f36bbc80c41c3596a1e4bf9501c6280481f1b9e06d07af354474e6f3ed366fef016df673a7ba&scene=21#wechat_redirect
[Decompilers online]: http://www.javadecompilers.com/
[Link 2]: https://github.com/jboss-javassist/javassist/blob/7302b8b0a09f04d344a26ebe57f29f3db43f2a3e/src/main/javassist/bytecode/AccessFlag.java#L32
