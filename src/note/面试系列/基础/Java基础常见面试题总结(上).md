...
> **🐛 修正（参见：[issue\#544][issue_544]）**：C++11 开始（2011 年的时候）,C++就引入了多线程库，在 windows、linux、macos 都可以使用`std::thread`和`std::async`来创建线程。参考链接：http://www.cplusplus.com/reference/thread/thread/?kw=thread
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083209613.png)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083210278.jpg)
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083210857.png)
...
在 [Java 9 新特性概览][Java 9]这篇文章中，我在介绍模块化系统的时候提到：
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083211158.png)

我们需要格外注意的是 `.class->机器码` 这一步。在这一步 JVM 类加载器首先加载字节码文件，然后通过解释器逐行解释执行，这种方式的执行速度会相对比较慢。而且，有些方法和代码块是经常需要被调用的(也就是所谓的热点代码)，所以后面引进了 **JIT（Just in Time Compilation）** 编译器，而 JIT 属于运行时编译。当 JIT 编译器完成第一次编译后，其会将字节码对应的机器码保存下来，下次可以直接使用。而我们知道，机器码的运行效率肯定是高于 Java 解释器的。这也解释了我们为什么经常会说 **Java 是编译与解释共存的语言** 。

> 🌈 拓展：[有关 JIT 的实现细节: JVM C1、C2 编译器][JIT _ JVM C1_C2]

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083211454.png) 

> HotSpot 采用了惰性评估(Lazy Evaluation)的做法，根据二八定律，消耗大部分系统资源的只有那一小部分的代码（热点代码），而这也就是 JIT 所需要编译的部分。JVM 会根据代码每次被执行的情况收集信息并相应地做出一些优化，因此执行的次数越多，它的速度就越快。

JDK、JRE、JVM、JIT 这四者的关系如下图所示。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083211744.png) 

下面这张图是 JVM 的大致结构模型。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083211972.png) 
 ...
 *  **编译型**：[编译型语言][Link 1] 会通过[编译器][Link 2]将源代码一次性翻译成可被该平台执行的机器码。一般情况下，编译语言的执行速度比较快，开发效率比较低。常见的编译性语言有 C、C++、Go、Rust 等等。
 *  **解释型**：[解释型语言][Link 3]会通过[解释器][Link 4]一句一句的将代码解释（interpret）为机器代码后再执行。解释型语言开发效率比较快，执行速度比较慢。常见的解释性语言有 Python、JavaScript、PHP 等等。

![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083212491.png)

根据维基百科介绍：

> 为了改善解释语言的效率而发展出的[即时编译][Link 5]技术，已经缩小了这两种语言间的差距。这种技术混合了编译语言与解释型语言的优点，它像编译语言一样，先把程序源代码编译成[字节码][Link 6]。到执行期时，再将字节码直译，之后执行。[Java][Java 3]与[LLVM][]是这种技术的代表产物。
> 
> 相关阅读：[基本功 | Java 即时编译器原理解析及实践][_ Java]
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083212841.png)
...
*  [基于静态编译构建微服务应用][JIT _ JVM C1_C2]
*  [走向 Native 化：Spring&Dubbo AOT 技术示例与原理讲解][Native _Spring_Dubbo AOT]
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083213813.jpg) 
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083214614.png)
...
官方文档：[https://docs.oracle.com/javase/tutorial/java/nutsandbolts/\_keywords.html][https_docs.oracle.com_javase_tutorial_java_nutsandbolts_keywords.html]
...
![笑小枫-www.xiaoxiaofeng.com](https://image.xiaoxiaofeng.site/spider/2024/11/20/xxf-1732083216469.png)
...
关于浮点数的更多内容，建议看一下[计算机系统基础（四）浮点数][Link 7]这篇文章。
...
关于 `BigDecimal` 的详细介绍，可以看看我写的这篇文章：[BigDecimal 详解][BigDecimal]。
...
**方法的重写要遵循“两同两小一大”**（以下内容摘录自《疯狂 Java 讲义》，[issue\#892][issue_892] ）：
...
[issue_544]: https://github.com/Snailclimb/JavaGuide/issues/544
...
[JavaSeSpecifications.jpg]: https://oss.javaguide.cn/github/javaguide/java/basis/JavaSeSpecifications.jpg
...
[Java 9]: https://javaguide.cn/java/new-features/java9.html
[Java 1]: https://oss.javaguide.cn/github/javaguide/java/basis/java-code-to-machine-code.png
[JIT _ JVM C1_C2]: https://mp.weixin.qq.com/s/4haTyXUmh8m-dBQaEzwDJw
[Java 2]: https://oss.javaguide.cn/github/javaguide/java/basis/java-code-to-machine-code-with-jit.png
[JDK_JRE_JVM_JIT]: https://oss.javaguide.cn/github/javaguide/java/basis/jdk-jre-jvm-jit.png
[JVM]: https://oss.javaguide.cn/github/javaguide/java/basis/jvm-rough-structure-model.png
[Link 1]: https://zh.wikipedia.org/wiki/%E7%B7%A8%E8%AD%AF%E8%AA%9E%E8%A8%80
[Link 2]: https://zh.wikipedia.org/wiki/%E7%B7%A8%E8%AD%AF%E5%99%A8
[Link 3]: https://zh.wikipedia.org/wiki/%E7%9B%B4%E8%AD%AF%E8%AA%9E%E8%A8%80
[Link 4]: https://zh.wikipedia.org/wiki/%E7%9B%B4%E8%AD%AF%E5%99%A8
[compiled-and-interpreted-languages.png]: https://oss.javaguide.cn/github/javaguide/java/basis/compiled-and-interpreted-languages.png
[Link 5]: https://zh.wikipedia.org/wiki/%E5%8D%B3%E6%99%82%E7%B7%A8%E8%AD%AF
[Link 6]: https://zh.wikipedia.org/wiki/%E5%AD%97%E8%8A%82%E7%A0%81
[Java 3]: https://zh.wikipedia.org/wiki/Java
[LLVM]: https://zh.wikipedia.org/wiki/LLVM
[_ Java]: https://tech.meituan.com/2020/10/22/java-jit-practice-in-meituan.html
[JIT vs AOT]: https://oss.javaguide.cn/github/javaguide/java/basis/jit-vs-aot.png
[GraalVM]: https://www.graalvm.org/
[Native _Spring_Dubbo AOT]: https://cn.dubbo.apache.org/zh-cn/blog/2023/06/28/%e8%b5%b0%e5%90%91-native-%e5%8c%96springdubbo-aot-%e6%8a%80%e6%9c%af%e7%a4%ba%e4%be%8b%e4%b8%8e%e5%8e%9f%e7%90%86%e8%ae%b2%e8%a7%a3/
[oracle jdk release cadence]: https://oss.javaguide.cn/github/javaguide/java/basis/oracle-jdk-release-cadence.jpg
[image-20220714112336911.png]: https://oss.javaguide.cn/github/javaguide/java/basis/image-20220714112336911.png
[https_docs.oracle.com_javase_tutorial_java_nutsandbolts_keywords.html]: https://docs.oracle.com/javase/tutorial/java/nutsandbolts/_keywords.html
[up-1ae0425ce8646adfb768b5374951eeb820d.png]: https://oss.javaguide.cn/github/javaguide/up-1ae0425ce8646adfb768b5374951eeb820d.png
[Link 7]: http://kaito-kidd.com/2018/08/08/computer-system-float-point/
[BigDecimal]: https://javaguide.cn/java/basis/bigdecimal.html
[issue_892]: https://github.com/Snailclimb/JavaGuide/issues/892
